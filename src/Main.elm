    ...
    Html.div []
        ...
        , Html.div
            ...
            [ if sudoku.correct then
                Html.img [ style [ ( "padding", "2px 259px" ), ( "border-radius", "15px" ) ], width 200, height 100, src "https://raw.githubusercontent.com/AndrejMC/elmHost/test/assets/correct.png" ] []
              else
                Html.img [ style [ ( "padding", "2px 259px" ), ( "border-radius", "15px" ) ], width 200, height 100, src "https://raw.githubusercontent.com/AndrejMC/elmHost/test/assets/incorrect.png" ] []
            ]
        ]
